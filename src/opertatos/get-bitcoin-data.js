const result = {
  data: {
    points: {
      1739021400: {
        v: [96197.9288089986, 49566346423.66, 1906785995314.49, 1, 19821487],
        c: [96197.9288089986, 49566346423.66, 1906785995314.49],
      },
      1739021700: {
        v: [96181.266301438, 49396049246.89, 1906455719637.49, 1, 19821487],
        c: [96181.266301438, 49396049246.89, 1906455719637.49],
      },
      1739022000: {
        v: [96363.4986133668, 48792029450.74, 1910067835039.37, 1, 19821487],
        c: [96363.4986133668, 48792029450.74, 1910067835039.37],
      },
      1739022300: {
        v: [96418.0797361551, 48582769907.11, 1911153956450.67, 1, 19821531],
        c: [96418.0797361551, 48582769907.11, 1911153956450.67],
      },
      1739022600: {
        v: [96387.4748731141, 49042780078.22, 1910547321209.15, 1, 19821531],
        c: [96387.4748731141, 49042780078.22, 1910547321209.15],
      },
      1739022900: {
        v: [96303.9558516111, 48570318159.8, 1908891846335.34, 1, 19821531],
        c: [96303.9558516111, 48570318159.8, 1908891846335.34],
      },
      1739107633: {
        v: [96358.9489860162, 22380075254.4203, 1910021594340.72, 1, 19821943],
      },
    },
  },
  status: {
          ...
          difference: {
            ...
            last: Number(
              (
                ...
                Object.entries(result.data.points)[
                  index == 0 ? 0 : index - 1
                ][1].v[0]
              ).toFixed(2)
            ),
